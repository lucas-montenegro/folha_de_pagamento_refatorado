public class Calendario {
    ...
    public void calculateFebruaryMonth() {
        calendary[1][0] = initialDay;
        calendary[1][2] = 28;
    ...
    public void calculate30DaysMonth(int i) {
    ...
    public void calculate31DaysMonths(int i) {
        calendary[i][0] = initialDay;
        calendary[i][2] = 31;
    ...
    public void initializeCalendary() {
        for (int i = 0; i < 12; i++) {
            if (i == 0 || i == 2 || i == 4 || i == 6 || i == 7 || i == 9 || i == 11) { calculate31DaysMonths(i); }
            else if (i == 1) { calculateFebruaryMonth(); }
            else if (i == 3 || i == 5 || i == 8 || i == 10) { calculate30DaysMonth(i); }
        }
    }
}
